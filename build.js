...
<div class="container">
    <div class="header" style="display: flex; justify-content: space-between; align-items: flex-start; gap: 0.75rem; flex-wrap: wrap;">
        <div>
            <div style="display: flex; align-items: center; gap: 8px; flex-wrap: wrap; margin-bottom: 0.25rem;">
                <h1 style="margin: 0; font-size: clamp(1.3rem, 5vw, 2rem); color: var(--text-color);">Formulir Pengisian CV LPK</h1>
                <span style="font-size: 0.75rem; background-color: #e8f0fe; color: var(--primary-color); padding: 2px 10px; border-radius: 12px; font-weight: 600; border: 1px solid #cce0ff; display: inline-flex; align-items: center; gap: 4px;">
    ...
    <form id="cv-form">
        ...
        <div class="card" id="step-9">
            ...
            <div style="text-align: center; margin-top: 1.5rem; padding-top: 1rem; border-top: 1px dashed var(--border-color); font-size: 0.85rem; color: #5f6368;">
                CV LPK Generator • <span style="color: var(--primary-color); font-weight: 600;">by Fadhli Muhammad</span>
            </div>
        </div>
    ...
    <footer style="text-align: center; margin-top: 2rem; margin-bottom: 1.5rem; font-size: 0.85rem; color: #5f6368; border-top: 1px solid var(--border-color); padding-top: 1.25rem;">
        <p style="margin: 0; font-weight: 500; color: #3c4043;">Formulir Pengisian CV LPK</p>
        <p style="margin: 0.35rem 0 0 0; font-size: 0.8rem; color: #70757a;">
            Watermark: <strong style="color: var(--primary-color); font-weight: 600;">by Fadhli Muhammad</strong>
        </p>
    </footer>
</div>

<div class="watermark-floating" style="position: fixed; bottom: 12px; right: 16px; font-size: 0.75rem; color: #5f6368; background: rgba(255, 255, 255, 0.92); padding: 5px 12px; border-radius: 20px; border: 1px solid var(--border-color); box-shadow: 0 2px 6px rgba(0,0,0,0.08); pointer-events: none; z-index: 999; backdrop-filter: blur(4px); font-weight: 500; display: flex; align-items: center; gap: 6px;">
